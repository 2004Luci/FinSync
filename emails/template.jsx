                    ...
                    <Container style={styles.container}>
                        ...
                        <Section style={styles.statsContainer}>
                            ...
                            <div style={styles.stat}>
                                ...
                                <Text style={styles.heading}>₹{data?.stats.totalIncome.toFixed(2) - data?.stats.totalExpenses.toFixed(2)}</Text>
                            </div>
                        </Section>
                        ...
                        {data?.insights && (
                            <Section style={styles.section}>
                                <Heading style={styles.heading}>FinSync Insights</Heading>
                        ...
                        <Text style={styles.footer}>
                            Thank you for using FinSync. Keep tracking your finances for better financial health!
                        </Text>
                    </Container>
                </Body>
            </Html>
